const ACTION_LABELS: Readonly<Record<string, string>> = {
  ...
  'voucher.updated': 'Voucher editado ou recarregado',
  'voucher.active': 'Voucher reativado',
  'voucher.cancelled': 'Voucher cancelado',
  'voucher.deleted': 'Voucher excluído com estornos',
